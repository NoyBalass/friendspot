...
export function ReviewCard({ review, index = 0, currentUserId, onPhotoAdded, onDeleted }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Add photo — anyone can add */}
      <label className={`mt-3 flex items-center gap-1.5 text-xs cursor-pointer transition-colors ${done ? 'text-emerald-500' : 'text-gray-300 hover:text-violet-400'}`}>
        {uploading ? (
